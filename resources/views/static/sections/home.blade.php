<section class="first_infobox wow fadeIn" data-wow-delay="0.6s">
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                <h3>Events</h3>
...
<section class="strecke wow fadeIn" data-wow-delay="0.6s">
    <div class="container">
        <img stlye="width: 100px;" src="{{ asset('/images/law_school/logo.png') }}" alt="" />
        <h3>Ein Projekt von Bucerius hilft in Kooperation mit der Behörde für Arbeit, Soziales, Familie und Integration (BASFI)</h3>
    </div>
</section>